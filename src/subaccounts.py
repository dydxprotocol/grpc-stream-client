...
def parse_subaccounts(stream_subaccount_update: StreamSubaccountUpdate) -> StreamSubaccount:
    """
    Parse the StreamSubaccountUpdate message into a StreamSubaccount dataclass.
    """
    subaccount_id = SubaccountId(
    ...
    asset_positions = {
        pos.asset_id: SubaccountAssetPosition(
