...
from grpc_stream_client.market_info import subticks_to_price, quantums_to_size
...
class TestMarketInfo(unittest.TestCase):
    ...
    def test_subticks_to_price(self):
        ...
        price = subticks_to_price(
            6988800000,
            cast(int, self.mock_market_info[0]["atomicResolution"]),
            cast(int, self.mock_market_info[0]["quantumConversionExponent"]),
        )
